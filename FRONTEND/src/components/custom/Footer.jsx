        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">Gadget Ghar</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Your trusted destination for premium gadgets and electronics. 
              Discover the latest technology with exceptional service and competitive prices.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-gray-400">
                ...
                <span>support@gadgetghar.com</span>
              </div>
              <div className="flex items-center gap-3 text-gray-400">
                <Phone className="w-4 h-4" />
                <span>+977 1-4-123456</span>
              </div>
              <div className="flex items-center gap-3 text-gray-400">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-gray-400">
              <span>© {currentYear} Gadget Ghar. All rights reserved.</span>
              <span>Made with</span>
