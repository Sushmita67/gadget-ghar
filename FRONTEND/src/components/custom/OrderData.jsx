...
const OrderData = ({
  ...
  const handleDownloadInvoice = async () => {
    try {
      ...
      page.drawText("GadgetGhar - Nepal", {
        x: 400,
        y: 750,
        size: 12,
        color: rgb(1, 1, 1),
      });
      page.drawText("Gyaneshwor, Kathmandu", { x: 400, y: 735, size: 10 });
      page.drawText("Email: hello@gadgetghar.com", {
        x: 400,
        y: 705,
        size: 10,
      });
      page.drawText("Phone: +977 9812234564", { x: 400, y: 690, size: 10 });
        ...
        return (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div className={`w-20 h-20 bg-gray-200 dark:bg-gray-700 flex items-center justify-center rounded-lg ${imageUrl ? 'hidden' : ''}`}>
            ...
            <div className="flex sm:flex-col gap-3 sm:gap-0 mt-2 sm:mt-0 sm:items-center">
              ...
              <p className="dark:bg-customYellow text-end ">
